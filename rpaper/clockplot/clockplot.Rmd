...
various event time data on chart we call 'Data Clock'. Given events occurring at
...
events along their corresponding timings. The existing method uses a line chart,
also known as a time series graph or line graph sample ref [@R-base]
