...
Now, to implement the entire concept, we rely on the `R` package `ggplot2` to produce better graphics and control. We need to create an `R` data frame for plotting ggplots. We also mark some 
points for minutes. 
...
```{r clock24, fig.height=4, fig.width=4, fig.align='center', fig.cap="The Clock Skeleton"}
