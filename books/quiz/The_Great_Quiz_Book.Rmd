...
[^L1]: The answer is 679

    **Explanation** 
    
    i. 523 are removed by clue no. 5
ii. 1 is removed by clue 3 & 4 (can't be in right and wrong position simultaneously)
iii. 8 is removed by clue 2 & 4 (can't be in right and wrong position simultaneously)
iv. 6 is correct digit by clue 2 (since 2 & are wrong)
v. Position of 6 is 1st (by clue 1 & 2, both wrong position)
vi. 9 is the 3rd digit in solution by clue 4 (since 1 & 8 are incorrect)
vii. 4 is removed by clue 1 (since two correct digits are 9 & 6)
viii. The 2nd digit in solution is 7 (by clue 3 and since no other digit exists)
