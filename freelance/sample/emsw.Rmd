...
```{r sbgdp, echo=FALSE, fig.cap = " Small Business Nominal GDP (1998-2014) in US economy", out.width = '50%'}
...
```{r spotify, echo=FALSE, fig.cap = "Userbase of Spotify at 15 consist of Half a Million Subscribers. Source: Statista", out.width = '70%'}
